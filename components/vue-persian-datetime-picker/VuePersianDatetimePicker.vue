  ...
  >
    ...
    <transition :name="isPopover ? '' : 'vpd-fade-scale'">
      <div
        v-if="true"
        ref="picker"
        style="z-index: 1000;position: relative;top: 200px;left: 0;"
        :data-type="type"
        @click.self="wrapperClick"
      >
        <div ref="container" class="vpd-container">
          <div class="vpd-content" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;border-radius: 8px;">
            <div
              v-if="!simple"
              class="vpd-header"
              :style="{ 'background-color': '#f5f5f5' , 'color' : 'black' , 'fontSize' : '16px' }"
              style="border-top-right-radius: 8px;border-top-left-radius: 8px;font-family: YekanBakh;"
            >
              <div
